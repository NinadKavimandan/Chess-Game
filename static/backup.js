			...
			switch(p)
			{
				...
				case "p":
					if(c == 1 && turn == 1)
					{
						...
						if(r+1 < 8)
						{
							if(findPiece(cell3).substring(0,1) == turnColr[1-turn]) document.getElementById(cell3).style.backgroundColor = "yellow";
						}
						if(r-1 > -1) if(findPiece(cell4).substring(0,1) == turnColr[1-turn]) document.getElementById(cell4).style.backgroundColor = "yellow";
						if(findPiece(cell1) == "none") 
						{
							document.getElementById(cell1).style.backgroundColor = "yellow";
							if(findPiece(cell2) == "none") document.getElementById(cell2).style.backgroundColor = "yellow";
						}
					}
					else if(c == 6 && turn == 0)
					{
						...
						if(r-1 > -1) if(findPiece(cell4).substring(0,1) == turnColr[1-turn]) document.getElementById(cell4).style.backgroundColor = "yellow";
						if(findPiece(cell1) == "none") document.getElementById(cell1).style.backgroundColor = "yellow";
					}
					break;
				case "r":
	...
	$('.cell').droppable({
		...
		drop: function(event,ui) {
			...
			if(isCheck(element,turnColr[1-turn])) 
			{
				...
				{
					document.getElementById("result").innerHTML = ""+playerColr[turn]+" won!";
...
function traversePath(currCell,r,c,inr,inc)
{
	...
	while(r<8 && r>-1 && c<8 && c>-1)
	{
		...
		if(t != "none") 
		{
			...
			if(top == turnColr[1-turn]) document.getElementById(cell).style.backgroundColor = "yellow";
...
{
	if(r+2 < 8 && c+1 < 8 && (findPiece(cols[r+2]+rows[c+1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+2]+rows[c+1]) == "none")) document.getElementById(cols[r+2]+rows[c+1]).style.backgroundColor = "yellow";
	if(r+2 < 8 && c-1 >= 0 && (findPiece(cols[r+2]+rows[c-1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+2]+rows[c-1]) == "none")) document.getElementById(cols[r+2]+rows[c-1]).style.backgroundColor = "yellow";
	if(r-2 >= 0 && c+1 < 8 && (findPiece(cols[r-2]+rows[c+1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-2]+rows[c+1]) == "none")) document.getElementById(cols[r-2]+rows[c+1]).style.backgroundColor = "yellow";
	if(r-2 >= 0 && c-1 >= 0 && (findPiece(cols[r-2]+rows[c-1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-2]+rows[c-1]) == "none")) document.getElementById(cols[r-2]+rows[c-1]).style.backgroundColor = "yellow";
	if(r+1 < 8 && c+2 < 8 && (findPiece(cols[r+1]+rows[c+2]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+1]+rows[c+2]) == "none")) document.getElementById(cols[r+1]+rows[c+2]).style.backgroundColor = "yellow";
	if(r+1 < 8 && c-2 >= 0 && (findPiece(cols[r+1]+rows[c-2]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+1]+rows[c-2]) == "none")) document.getElementById(cols[r+1]+rows[c-2]).style.backgroundColor = "yellow";
	if(r-1 >= 0 && c+2 < 8 && (findPiece(cols[r-1]+rows[c+2]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-1]+rows[c+2]) == "none")) document.getElementById(cols[r-1]+rows[c+2]).style.backgroundColor = "yellow";
	if(r-1 >= 0 && c-2 >= 0 && (findPiece(cols[r-1]+rows[c-2]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-1]+rows[c-2]) == "none")) document.getElementById(cols[r-1]+rows[c-2]).style.backgroundColor = "yellow";
}
function kingPath(currCell,r,c)
{
	if(r+1 < 8 && c+1 < 8 && (findPiece(cols[r+1]+rows[c+1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+1]+rows[c+1]) == "none")) document.getElementById(cols[r+1]+rows[c+1]).style.backgroundColor = "yellow";
	if(r+1 < 8 && c-1 >= 0 && (findPiece(cols[r+1]+rows[c-1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+1]+rows[c-1]) == "none")) document.getElementById(cols[r+1]+rows[c-1]).style.backgroundColor = "yellow";
	if(r-1 >= 0 && c+1 < 8 && (findPiece(cols[r-1]+rows[c+1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-1]+rows[c+1]) == "none")) document.getElementById(cols[r-1]+rows[c+1]).style.backgroundColor = "yellow";
	if(r-1 >= 0 && c-1 >= 0 && (findPiece(cols[r-1]+rows[c-1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-1]+rows[c-1]) == "none")) document.getElementById(cols[r-1]+rows[c-1]).style.backgroundColor = "yellow";
	if(r+1 < 8 && (findPiece(cols[r+1]+rows[c]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r+1]+rows[c]) == "none")) document.getElementById(cols[r+1]+rows[c]).style.backgroundColor = "yellow";
	if(c+1 < 8 && (findPiece(cols[r]+rows[c+1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r]+rows[c+1]) == "none")) document.getElementById(cols[r]+rows[c+1]).style.backgroundColor = "yellow";
	if(r-1 >= 0 && (findPiece(cols[r-1]+rows[c]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r-1]+rows[c]) == "none")) document.getElementById(cols[r-1]+rows[c]).style.backgroundColor = "yellow";
	if(c-1 >= 0 && (findPiece(cols[r]+rows[c-1]).substring(0,1) == turnColr[1-turn] || findPiece(cols[r]+rows[c-1]) == "none")) document.getElementById(cols[r]+rows[c-1]).style.backgroundColor = "yellow";	
}
function killIt(loc)
{
